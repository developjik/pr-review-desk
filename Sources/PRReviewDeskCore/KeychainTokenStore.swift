...
public protocol StoredGitHubCredentialLoading: Sendable {
    func loadStoredCredential() throws -> StoredGitHubCredential?
}
...
extension VersionedCredentialStore: StoredGitHubCredentialLoading {}
