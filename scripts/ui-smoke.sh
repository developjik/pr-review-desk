...
required=(
  ...
  "interaction=command-panel-keyboard:selected-section=draftReady"
  ...
  "accessibility=review-inbox.empty-draft-ready:rendered-controls=review-inbox.empty-placeholder,review-inbox.empty.queue-repository"
